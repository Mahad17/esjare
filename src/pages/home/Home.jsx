...
import cardImageOne from "../../assets/nlpCard.png";
import cardImageTwo from "../../assets/pamCard.png";
import cardImageThree from "../../assets/apmCard.png";
import cardImageFour from "../../assets/cdsmbCard.png";
import cardImageFive from "../../assets/iaasCard.png";
import cardImageSix from "../../assets/otherServicesCard.png";
				...
				<div className="homeDivThree">
					...
					>
						{cardData.map((card, index) => (
							<div
								key={index}
								className="col col-lg-4 col-md-6 col-sm-12 px-4 d-flex justify-content-center pt-4 pb-5"
							>
								<CardComp
									image={card.image}
