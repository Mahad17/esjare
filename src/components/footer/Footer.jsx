			...
			<section className="footerSection">
				...
				>
					<div className="col col-lg-4 col-md-6 col-sm-12 col-12">
						<h3 style={{ color: "#0071cdd5", fontWeight: "700" }}>About Us</h3>
					...
					<div style={{display:"flex", justifyContent:"center"}} className="col col-lg-4 col-md-3 col-sm-6 col-6">
						<div>
							<h3 style={{ color: "#0071cdd5", fontWeight: "700" }}>
								Quick Links
							</h3>
					...
					<div className="col col-lg-4 col-md-3 col-sm-6 col-6">
						<h3 style={{ color: "#0071cdd5", fontWeight: "700" }}>Important</h3>
						<ul style={{ fontWeight: "500" }}>
							<li>
				...
				<div
					className="row p-3"
					style={{ margin: 0, width: "100%", background: "#0071cdd5" }}
				>
					<div
						className="col-12"
